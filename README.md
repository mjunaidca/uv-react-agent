...
2. Rename .env.example to .env and add LangSmith and Google API Key

3. Open in Dev Container > User Prebuilt Python3 Option  Python 12 > Docker Inside COntainer Feature and:
  - pip install uv
  - pip install -U langgraph-cli
  - langgraph build -t mjunaidca/react-agent

Or you can directly run there if devcontainer give any error
  - pip install -U langgraph-cli
  - langgraph build -t mjunaidca/react-agent

Or if you use UV as package manager
- uv venv
